...
class SimpleCNN3D(nn.Module):
    def __init__(self, num_classes=50, in_channels=3, kernel_size=1):
        super().__init__()
        ...
        self.parallel1 = ParallelBranch(32, 16, 16, kernel_size=kernel_size)
        self.parallel2 = ParallelBranch(32, 8, 16, kernel_size=kernel_size)
        self.parallel3 = ParallelBranch(32, 4, 16, kernel_size=kernel_size)
...
if __name__ == "__main__":
    model = SimpleCNN3D(num_classes=50)
